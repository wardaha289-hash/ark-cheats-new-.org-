...
const UI_REPLACEMENTS = [
	...
	['Tarkov PC', 'ARK: Survival Ascended PC'],
	...
	['Trucos Tarkov', 'Trucos ARK: Survival Ascended'],
	['Triches Tarkov', 'Triches ARK: Survival Ascended'],
	['Cheats Tarkov', 'Cheats ARK: Survival Ascended'],
];
...
pagesEn = pagesEn.replace(/ARK: Survival Ascended Tarkov/g, 'ARK: Survival Ascended');
pagesEn = pagesEn.replace(/for ARK: Survival Ascended Tarkov/g, 'for ARK: Survival Ascended');
