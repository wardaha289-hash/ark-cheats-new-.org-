...
const REPLACEMENTS = [
	...
	['ark-cheats', 'escape-from-ark-cheats'],
	...
	['unentdeckte-ark-cheats', 'unentdeckte-escape-from-ark-cheats'],
	...
	['basta-ark-cheats', 'basta-escape-from-ark-cheats'],
...
async function fixConstants() {
	const heroImages = `/** Hero image per page topic — keyword-rich escape-from-ark-cheats paths. */
export const HERO_IMAGES = {
	home: '/images/escape-from-ark-cheats-hero.webp',
	'ark-esp': '/images/escape-from-ark-cheats-esp-wallhack.webp',
	'ark-aimbot': '/images/escape-from-ark-cheats-aimbot-combat.webp',
	features: '/images/escape-from-ark-cheats-package.webp',
	pricing: '/images/escape-from-ark-cheats-cover.webp',
	setup: '/images/tarkov-loadout-builder.webp',
	updates: '/images/tarkov-header-art.webp',
	faq: '/images/tarkov-squad-fight.webp',
	support: '/images/escape-from-ark-cheats-package.webp',
	undetected: '/images/tarkov-battle-royale-combat.webp',
	wallhack: '/images/escape-from-ark-cheats-esp-wallhack.webp',
	radar: '/images/tarkov-player-esp.webp',
	'eac': '/images/tarkov-reboot-van-fight.webp',
	'cheats-2026': '/images/escape-from-ark-cheats-hero.webp',
	privacy: '/images/escape-from-ark-cheats-aimbot-combat.webp',
	refund: '/images/escape-from-ark-cheats-cover.webp',
	terms: '/images/escape-from-ark-cheats-package.webp',
};`;
