...
const KEYWORD_ASSETS = [
	{ file: 'escape-from-ark-cheats-hero.webp', url: `${CDN_GALLERY}/tarkov-gameplay-screenshots-2024_s2qs.1400.jpg` },
	{ file: 'escape-from-ark-cheats-cover.webp', url: `${CDN_B}/tarkov-battle-royale-chapter-5-season-1-screenshot-a-1920x_xkzh.1400.jpg` },
	{ file: 'tarkov-loadout-builder.webp', url: `${CDN_B}/tarkov-battle-royale-chapter-5-season-1-screenshot-b-1920x_8z8k.1400.jpg` },
	{ file: 'escape-from-ark-cheats-aimbot-combat.webp', url: `${CDN_B}/tarkov-battle-royale-chapter-5-season-1-screenshot-c-1920x_vu5r.1400.jpg` },
	{ file: 'tarkov-squad-fight.webp', url: `${CDN_B}/tarkov-battle-royale-chapter-5-season-1-screenshot-d-1920x_mzsk.1400.jpg` },
	{ file: 'escape-from-ark-cheats-esp-wallhack.webp', url: `${CDN_B}/tarkov-battle-royale-chapter-5-season-1-train-1920x1080-a1_1nkx.1400.jpg` },
	{ file: 'escape-from-ark-cheats-package.webp', url: 'https://sm.ign.com/t/ign_latam/gallery/f/tarkov-c/tarkov-chapter-5-underground-images_5h3j.1400.jpg' },
...
const LEGACY_PATTERNS = [
	/^tarkov-tribe base-fight/,
	/^tarkov-operator-esp/,
	/^tarkov-verdansk-combat/,
	/^tarkov-dino-run-mode/,
	/^tarkov-al-mazrah-map/,
];

async function fetchWebp(url) {
	const res = await fetch(url, {
		headers: { 'User-Agent': 'Mozilla/5.0 (compatible; ArkCheatsSite/1.0)' },
	});
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'escape-from-ark-cheats-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		if (asset.file === 'escape-from-ark-cheats-hero.webp') heroBuffer = webp;
	} catch (err) {
