...
export const enPages = {
	home: {
		...
		description:
			'Ark cheats for Windows PC — ESP, soft aim, radar, and Easy Anti-Cheat updates. Compare plans and buy.',
		h1: 'Ark Cheats — Undetected ESP, Wallhack & Aimbot',
		intro:
			'Ark Cheats is the undetected ark cheats package for Windows PC — built for ARK: Survival Ascended on Windows PC. Tarkov esp wallhack, 2D radar, and tarkov aimbot with Easy Anti-Cheat maintenance after every major patch.',
		...
		sections: [
			section(
				'Why players choose Ark cheats in 2026',
				...
				`Official seasons, patches, and anti-cheat updates come from ${EXT.tarkov} and ${EXT.eac}. We rebuild ESP, radar, and Aimbot modules when those patches require maintenance — then post status on the <a href="/updates/">Updates page</a>.`,
			...
			section(
				...
				`Before patch days, check ${EXT.status} for Battlestate Games service health, then confirm our maintenance notes so you are not joining on an outdated build.`,
	...
	'ark-esp': {
		...
		description:
			'Tarkov ESP for Windows PC — player boxes, loot markers, and distance readouts. Part of our undetected ark cheats for ARK: Survival Ascended.',
		h1: 'Tarkov ESP — Player Boxes & Wallhack',
		intro:
			'Tarkov esp visibility tools for session and dino-run. Read enemy squads, players, wild dinos, loot, and distance before you commit — toggleable tarkov esp wallhack overlays bundled in our ark cheats package.',
		...
		sections: [
			section(
				'What Tarkov ESP solves in sessions',
			...
			section(
				'Player, alpha dino, and loot ESP wallhack categories',
	...
	'ark-aimbot': {
		...
		description:
			'Tarkov aimbot with soft aim tuning for Windows PC. FOV, bone priority, and hotkeys bundled with ESP boxes in our ark cheats package.',
		...
		sections: [
			...
			section(
				...
				`Cross-check service health on ${EXT.status} and anti-cheat context on ${EXT.eac}, then follow our <a href="/updates/">Easy Anti-Cheat maintenance guide</a> before joining on patch day.`,
	...
	features: {
		...
		intro:
			'Every ESP wallhack, radar hack, and Aimbot control included in the Ark Cheats package for Tarkov on Windows PC — with Easy Anti-Cheat maintenance after major patches.',
		...
		sections: [
			...
			section(
				...
				`Monitor ${EXT.status} on patch days, then confirm rebuild notes before you join. Setup and billing help lives on <a href="/support/">Support</a> and support@arkcheats.org.`,
	...
	pricing: {
		...
		description:
			'Ark cheats pricing: $35/month or $150 lifetime for ESP, soft aim, and radar on Windows PC. Instant delivery — pick a plan.',
		h1: 'Ark Cheats Pricing — Monthly & Lifetime',
		intro:
			'Choose monthly or lifetime access to undetected Ark Cheats — ESP wallhack, radar hack, and Aimbot for Tarkov on Windows PC. Instant digital delivery after payment.',
		...
		sections: [
			section(
				'Monthly and lifetime Ark Cheats plans',
	...
	setup: {
		...
		description:
			'Set up ark cheats on Windows PC — activate ESP boxes, soft aim profiles, and . Check Easy Anti-Cheat updates before your first join.',
		h1: 'Ark Cheats Setup — Windows PC Guide',
		intro:
			'Install and configure Ark Cheats for Tarkov on Windows 10 or 11. Activate your license, load ESP wallhack and Aimbot profiles, and verify Easy Anti-Cheat maintenance status before joining.',
		...
		sections: [
			...
			section(
				'After Tarkov or Easy Anti-Cheat patches',
				...
				`Official anti-cheat background: ${EXT.eac}. Our practical workflow is documented on the <a href="/updates/">Easy Anti-Cheat bypass page</a> and <a href="/ark-cheats/">undetected guide</a>.`,
	...
	updates: {
		...
		description:
			'Ark cheats update log: Easy Anti-Cheat rebuilds for ESP boxes, soft aim, and radar on Windows PC. Check status before joining after patches.',
		h1: 'Ark Cheats Updates — Maintenance Log',
		intro:
			'Track Easy Anti-Cheat maintenance and Tarkov patch rebuilds for the undetected ESP wallhack, radar hack, and Aimbot package. Check here before joining after major updates.',
		...
		sections: [
			section(
				...
				`Use ${EXT.status} for Battlestate Games platform health and this page for Ark Cheats build status — both matter on big update days.`,
			...
			section(
				...
				`Follow season notes from ${EXT.tarkov}, then confirm our rebuild is live before you join.`,
	...
	faq: {
		...
		description:
			'Ark cheats FAQ: ESP boxes, soft aim, Easy Anti-Cheat maintenance, and pricing for PC. Clear answers before you buy.',
		h1: 'Ark Cheats FAQ — Common Questions',
		intro:
			'Answers about undetected Ark Cheats — ESP wallhack, radar hack, Aimbot, Easy Anti-Cheat maintenance, checkout, and Tarkov compatibility on Windows PC.',
		...
		sections: [
			...
			section(
				'Are Ark Cheats undetected in 2026?',
	...
	support: {
		...
		intro:
			'Get help with Ark Cheats licenses, checkout, ESP wallhack setup, Aimbot profiles, and Easy Anti-Cheat maintenance for Tarkov on Windows PC.',
	...
	undetected: {
		...
		description:
			'Undetected ark cheats with Easy Anti-Cheat maintenance for ESP boxes, soft aim, and radar on Windows PC. Check status before you join.',
		h1: 'Undetected Ark Cheats — Easy Anti-Cheat Maintenance',
		intro:
			'How Ark Cheats stays maintained for Tarkov after Easy Anti-Cheat patches — ESP wallhack, radar hack, and Aimbot rebuilds for Windows PC.',
		...
		sections: [
			section(
				'What undetected means for Ark Cheats',
				...
				`Anti-cheat technology is documented by ${EXT.eac}; Tarkov client updates ship through ${EXT.activision}. Undetected status is an ongoing process tied to those releases.`,
			),
			section(
	...
	wallhack: {
		...
		description:
			'Tarkov wallhack ESP with player boxes and loot markers for Windows PC. Undetected ark cheats — learn overlays and buy.',
		h1: 'Tarkov Wallhack — ESP Boxes & Visibility',
		intro:
			'Tarkov wallhack ESP for Tarkov — see players, loot, alpha dinos, and containers through toggleable wallhack overlays built for PvP servers and dino-runs.',
	...
	radar: {
		...
		description:
			'Tarkov radar hack for flank awareness on Windows PC. Bundled with ESP boxes, soft aim, and radar in our ark cheats package.',
	...
	'eac': {
		...
		description:
			'How ark cheats rebuild after Easy Anti-Cheat patches — ESP boxes, soft aim, and radar maintenance for Windows PC. Read before joining.',
		h1: 'Easy Anti-Cheat Bypass — Ark Cheats Maintenance',
		intro:
			'Understand Easy Anti-Cheat maintenance for Ark Cheats — how ESP wallhack, radar hack, and Aimbot rebuild after Tarkov security updates.',
		...
		sections: [
			section(
				...
				`Easy Anti-Cheat is Battlestate Games' anti-cheat for Tarkov on PC (see ${EXT.eac}). Security updates can affect ESP wallhack, radar, and Aimbot behavior — requiring maintenance rebuilds for undetected packages.`,
				`Ark Cheats monitors Easy Anti-Cheat patch notes and Tarkov seasonal updates from ${EXT.tarkov} to schedule module reviews.`,
	...
	'cheats-2026': {
		...
		description:
			'Best ark cheats 2026: ESP boxes, soft aim, and radar for Windows PC. Undetected ark cheats with Easy Anti-Cheat maintenance — compare and buy.',
		h1: 'Ark Cheats 2026 — ESP, Soft Aim & Radar',
		intro:
			'The 2026 Ark Cheats package for Tarkov — undetected ESP wallhack, radar hack, and Aimbot with Easy Anti-Cheat maintenance, instant delivery, and Windows PC support.',
		...
		sections: [
			section(
				'Why ark cheats buyers choose Ark Cheats in 2026',
	...
	hacks: {
		...
		description:
			'Ark cheats for Windows PC: undetected ESP wallhack, radar hack, and Aimbot with Easy Anti-Cheat maintenance. Compare ark cheats options and buy the full package.',
		h1: 'Ark Cheats — Undetected ESP, Aimbot & Wallhack',
		intro:
			'Ark cheats for session and dino-run combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after Easy Anti-Cheat patches. This is the pillar guide for ark cheats in 2026.',
		...
		sections: [
			section(
				'What Ark cheats include in 2026',
				...
				`Official game updates come from ${EXT.tarkov}; our hacks package tracks those releases via the <a href="/updates/">Updates page</a>. Cross-check platform health on ${EXT.status} before patch-day joins.`,
			),
			section(
			...
			section(
				'Ark cheats vs single-feature tools',
			...
			section(
				'Undetected Ark cheats with Easy Anti-Cheat maintenance',
				...
				`See ${EXT.eac} for anti-cheat background and our <a href="/updates/">Easy Anti-Cheat bypass guide</a> for the practical workflow. Pair with <a href="/ark-cheats/">undetected Ark cheats</a> for status language buyers expect.`,
	...
	'cheat-download': {
		...
		intro:
			'How Ark cheat download works for Tarkov — digital license delivery after payment confirmation, with ESP wallhack, radar hack, and Aimbot access on Windows PC.',
	...
	'mod-menu': {
		...
		description:
			'Tarkov mod menu for in-match toggles — ESP boxes, soft aim, radar, and on Windows PC. Undetected ark cheats package.',
		...
		sections: [
			...
			section(
				'Mod menu categories for PvP servers and dino-runs',
	...
	'soft-aim': {
		...
		description:
			'Tarkov soft aim settings for natural tracking on Windows PC. Smoothness, FOV, and bone priority — included in our ark cheats with ESP boxes.',
	...
	'best-cheats': {
		...
		description:
			'Best ark cheats for 2026: ESP boxes, soft aim, and Easy Anti-Cheat maintenance on Windows PC. Use this checklist before checkout.',
		h1: 'Best Ark Cheats — 2026 Buyer Guide',
		intro:
			'Compare the Ark cheats for Tarkov in 2026 — undetected ESP wallhack, radar hack, and Aimbot in one maintained package with Easy Anti-Cheat rebuilds and instant delivery.',
		...
		sections: [
			section(
				'What makes the Ark cheats in 2026',
			...
			section(
				'Best Ark cheats feature checklist',
	...
	'aimbot-hack': {
		...
		description:
			'Tarkov aimbot hack with soft aim for Windows PC. FOV, bone priority, and hotkeys — bundled with ESP boxes in our ark cheats package.',
	...
	'esp-hack': {
		...
		description:
			'Tarkov ESP hack with player boxes and loot markers for Windows PC. Undetected ark cheats with — see overlays and buy.',
		h1: 'Tarkov ESP Hack — Player Boxes Guide',
		intro:
			'Tarkov ESP hack overlays for Tarkov — player outlines, alpha dino threat cues, loot and container markers with distance readouts across session and dino-run.',
	...
	'unlock-all': {
		...
		description:
			'Tarkov unlock all explained vs real ark cheats — ESP boxes, soft aim, and radar for Windows PC. Know what you are buying.',
		h1: 'Tarkov Unlock All — What Players Search For',
		intro:
			'Tarkov unlock all is a common search term for Tarkov — this page clarifies what unlock-all tools claim versus the ESP wallhack, radar hack, and Aimbot tools Ark Cheats actually provides on Windows PC.',
		...
		sections: [
			...
			section(
				'Buying Ark Cheats for the right reasons',
	...
	privacy: {
		...
		description:
			'Privacy policy for Ark Cheats. How we handle support emails, order data, and checkout for ark cheats licenses on arkcheats.org.',
		h1: 'Privacy Policy',
	...
	refund: {
		...
		description:
			'Refund policy for Ark Cheats. Digital delivery terms and eligibility for ark cheats packages with ESP, soft aim, and radar.',
		h1: 'Refund Policy',
		intro:
			'Refund terms for Ark Cheats licenses — ESP wallhack, radar hack, and Aimbot packages purchased through checkout for Tarkov.',
	...
	terms: {
		...
		description:
			'Terms of use for arkcheats.org and Ark Cheats licenses. Usage rules, anti-cheat risk, and liability for Windows PC cheats.',
		h1: 'Terms of Use',
