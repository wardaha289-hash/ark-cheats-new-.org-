...
export const phrases = {
	es: {
		buy: 'Comprar Ark Cheats', undetected: 'indetectables', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contacta support@arkcheats.org para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Ark Cheats', undetected: 'indétectables', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contactez support@arkcheats.org pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Ark Cheats kaufen', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Ark Cheats', undetected: 'indetectáveis', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contacte support@arkcheats.org para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Ark Cheats', undetected: 'indetectable', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Contatta support@arkcheats.org per supporto o richieste legali.',
	},
	nl: {
		buy: 'Ark Cheats kopen', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Ark Cheats satın al', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'Destek ve yasal sorular için support@arkcheats.org.',
	},
	ar: {
		buy: 'اشترِ Ark Cheats', undetected: 'غير مكتشف', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Ark Cheatsを購入', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'サポート・法務: support@arkcheats.org',
	},
	ko: {
		buy: 'Ark Cheats 구매', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => '지원 및 법무: support@arkcheats.org',
	},
	zh: {
		buy: '购买 Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => '支持与法务：support@arkcheats.org',
	},
	hi: {
		buy: 'Ark Cheats खरीदें', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'सहायता: support@arkcheats.org',
	},
	id: {
		buy: 'Beli Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Ark Cheats', undetected: 'undetected', maps: 'The Island, Scorched Earth, and Aberration',
		...
		legal: () => 'support@arkcheats.org för support och juridik.',
	},
};
