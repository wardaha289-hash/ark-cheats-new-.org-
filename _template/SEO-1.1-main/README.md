# Ark Cheats — Marketing Site

Static Astro 7 site for [arkcheats.org](https://arkcheats.org). Primary SEO keyword: **ark cheats** (secondary: escape from ark cheats, aimbot, ESP).
...
5. Add custom domain **arkcheats.org** (apex) and redirect **www** → apex
...
Private — for arkcheats.org deployment only.
