...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
		...
		sections: [
			{
				h2: 'ESP & wallhack',
				paragraphs: [
					'See players, wild dinos, alpha dinos, and loot through walls with distance readouts.',
					'Use filters so the overlay stays clear in dorms, Factory, and dino-run chaos.',
				],
				list: ['Player boxes & distance', 'Loot and tribe base markers', 'Boss and dino filters'],
			},
			{
				h2: 'Aimbot & soft aim',
				paragraphs: [
					'Aim help you can tune to feel natural.',
					'Set FOV, smoothness, and bone priority per weapon before you session.',
				],
			...
			},
			{
				...
				paragraphs: [
					...
					'Spot flanks near tribe bases without filling the whole screen.',
				],
	...
	hacks: page({
		...
		sections: [
			...
			{
				h2: 'Built for Tarkov sessions',
				paragraphs: [
					'Read players and wild dinos before you push, mark loot worth the risk, and stay aware near tribe bases. Tune soft aim per weapon class for dorms, Factory, and long-range maps.',
				],
				list: [
	...
	'ark-esp': page({
		...
		description:
			'Tarkov ESP and wallhack for ARK: Survival Ascended on Windows PC — player boxes, distance, loot filters, and clear overlays in sessions.',
		h1: 'ESP',
		intro: 'See players and loot through walls during Tarkov sessions. Part of the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Ark Cheats overview',
		ctaSecondaryHref: '/ark-cheats/',
	...
	'ark-aimbot': page({
		...
		description:
			'Tarkov aimbot and soft aim for ARK: Survival Ascended on Windows PC — FOV, smoothness, and bone priority you can tune per weapon.',
		h1: 'Aimbot',
