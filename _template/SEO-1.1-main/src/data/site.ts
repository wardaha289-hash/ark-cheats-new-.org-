...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'Yes. {brand} includes 2D radar overlays that highlight nearby threats outside your view — useful for flanks and tribe base holds.',
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_EFT',
		rating: 5,
		text: 'Soft aim in Ark Cheats feels smooth on Customs. The menu took a few minutes to learn. After that, sessions felt easy.',
		short: 'Soft aim in Ark Cheats feels smooth on Customs.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Ark Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Ark Cheats is easy to tune on PC.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Ark Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on Woods is solid.',
	...
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Ark Cheats pays for the monthly plan. Extract markers and distance make early sessions faster.',
		short: 'Loot ESP in Ark Cheats pays for the monthly plan.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Ark Cheats since last wipe. Soft aim per weapon helps in dorms. Status updates after Easy Anti-Cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Ark Cheats helps in dorms.',
		slug: 'ark-soft-aim-session-review-rankedgrind42',
	...
	reviewMeta({
		handle: 'vanLifeEFT',
		rating: 5,
		text: 'Radar in Ark Cheats saved me near tribe bases. Seeing the third party early in duos is huge. Boxes plus radar look clean.',
		short: 'Radar in Ark Cheats saved me near tribe bases.',
		slug: 'ark-radar-hack-review-vanlifeeft',
		seoTitle: 'Radar Review by @vanLifeEFT — 5/5 | {brand}',
		seoDescription: '@vanLifeEFT rates {brand} radar 5/5 near tribe bases on Windows PC.',
		date: '2026-07-28',
		tag: 'Extracts',
	}),
	reviewMeta({
		...
		slug: 'tarkov-eac-update-review-patchdaymike',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Ark Cheats is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Ark Cheats is excellent.',
