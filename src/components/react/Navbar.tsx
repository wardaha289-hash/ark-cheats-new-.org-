...
const icons: Record<string, string> = {
	home: 'M5.5 11.2 12 6.2l6.5 5M7 11.2V18a1.2 1.2 0 001.2 1.2h7.6A1.2 1.2 0 0017 18v-6.8M10.2 19.2V14h3.6v5.2',
	hacks:
	...
	forums:
		'M8 6h8M8 10h8M8 14h5M6 4.8h12a1.2 1.2 0 011.2 1.2v12a1.2 1.2 0 01-1.2 1.2H6A1.2 1.2 0 014.8 18V6A1.2 1.2 0 016 4.8z',
};
...
function NavbarInner({
	...
	const navLinks = useMemo(
		() =>
			links.map((item) => ({
				...item,
				label: item.label ?? (item.labelKey ? t(item.labelKey) : item.id),
	...
	return (
		<header className={`site-header${scrolled || open ? ' is-scrolled' : ''}${open ? ' is-open' : ''}`} data-nav>
			<div className="shell site-header__bar">
				<a className="site-brand" href={homeHref} data-edit="name" aria-label={siteName}>
					<span className="site-brand__mark">Ark</span>
					<span className="site-brand__accent">Cheats</span>
				</a>
