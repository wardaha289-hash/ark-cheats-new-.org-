...
const seoDefaults = {
	...
	forumsDescription:
		'Community threads for {brand} — setup, ESP, aimbot, profiles, and {antiCheat} notes for {game}.',
} as const;
...
/** Forums eyebrow / nav label */
export const forumsLabel = fillBrandTokens(brandCopy.forumsLabel ?? 'Forums');
...
export const productInfo = {
	...
	features: {
		esp: [
			'Player ESP / wallhack',
			'Dino ESP with dino filters',
			'Item ESP for loot and resources',
			'Distance readouts',
			'Toggleable ESP categories',
			'Corpse and supply crate highlights',
		],
		aimbot: [
		...
		radar: ['No recoil', 'No spread', 'Rapid fire'],
		general: [
