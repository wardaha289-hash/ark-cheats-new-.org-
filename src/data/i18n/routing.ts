...
import { getForumThreadPath, getForumsBasePath } from '../forums';
...
export const localizedSlugs: Record<PageId, Record<LocaleCode, string>> = {
	...
	features: {
		...
		de: 'escape-from-ark-cheats-funktionen',
		pt: 'recursos-cheats-ark',
		it: 'funzioni-trucchi-ark',
		nl: 'escape-from-ark-cheats-functies',
		pl: 'funkcje-cheatow-ark',
		ru: 'funkcii-chitov-ark',
		tr: 'ark-hile-ozellikleri',
		ar: 'escape-from-ark-cheats-features',
		ja: 'escape-from-ark-cheats-features',
		ko: 'escape-from-ark-cheats-features',
		zh: 'escape-from-ark-cheats-features',
		hi: 'escape-from-ark-cheats-features',
		id: 'escape-from-ark-cheats-features',
		th: 'escape-from-ark-cheats-features',
		vi: 'escape-from-ark-cheats-features',
		uk: 'funkcii-chitiv-ark',
		cs: 'escape-from-ark-cheats-funkce',
		ro: 'functii-cheats-ark',
		sv: 'escape-from-ark-cheats-funktioner',
	},
	pricing: {
		en: 'pricing',
		es: 'precios-trucos-ark',
		fr: 'prix-triche-ark',
		de: 'escape-from-ark-cheats-preise',
		pt: 'precos-cheats-ark',
		it: 'prezzi-trucchi-ark',
		nl: 'escape-from-ark-cheats-prijzen',
		pl: 'ceny-cheatow-ark',
		ru: 'ceny-chitov-ark',
		tr: 'ark-hile-fiyatlari',
		ar: 'escape-from-ark-cheats-pricing',
		ja: 'escape-from-ark-cheats-pricing',
		ko: 'escape-from-ark-cheats-pricing',
		zh: 'escape-from-ark-cheats-pricing',
		hi: 'escape-from-ark-cheats-pricing',
		id: 'escape-from-ark-cheats-pricing',
		th: 'escape-from-ark-cheats-pricing',
		vi: 'escape-from-ark-cheats-pricing',
		uk: 'ciny-chitiv-ark',
		cs: 'escape-from-ark-cheats-ceny',
		ro: 'preturi-cheats-ark',
		sv: 'escape-from-ark-cheats-priser',
	},
	setup: {
		en: 'setup',
		es: 'instalacion-trucos-ark',
		fr: 'installation-triche-ark',
		de: 'escape-from-ark-cheats-installation',
		pt: 'instalacao-cheats-ark',
		it: 'installazione-trucchi-ark',
		nl: 'escape-from-ark-cheats-installatie',
		pl: 'instalacja-cheatow-ark',
		ru: 'ustanovka-chitov-ark',
		tr: 'ark-hile-kurulum',
		ar: 'escape-from-ark-cheats-setup',
		ja: 'escape-from-ark-cheats-setup',
		ko: 'escape-from-ark-cheats-setup',
		zh: 'escape-from-ark-cheats-setup',
		hi: 'escape-from-ark-cheats-setup',
		id: 'escape-from-ark-cheats-setup',
		th: 'escape-from-ark-cheats-setup',
		vi: 'escape-from-ark-cheats-setup',
		uk: 'vstanovka-chitiv-ark',
		cs: 'escape-from-ark-cheats-instalace',
		ro: 'instalare-cheats-ark',
		sv: 'escape-from-ark-cheats-installation',
	},
	updates: {
		en: 'updates',
		es: 'actualizaciones-trucos-ark',
		fr: 'mises-a-jour-triche-ark',
		de: 'escape-from-ark-cheats-updates',
		pt: 'atualizacoes-cheats-ark',
		it: 'aggiornamenti-trucchi-ark',
		nl: 'escape-from-ark-cheats-updates',
		pl: 'aktualizacje-cheatow-ark',
		ru: 'obnovleniya-chitov-ark',
		tr: 'ark-hile-guncellemeleri',
		ar: 'escape-from-ark-cheats-updates',
		ja: 'escape-from-ark-cheats-updates',
		ko: 'escape-from-ark-cheats-updates',
		zh: 'escape-from-ark-cheats-updates',
		hi: 'escape-from-ark-cheats-updates',
		id: 'escape-from-ark-cheats-updates',
		th: 'escape-from-ark-cheats-updates',
		vi: 'escape-from-ark-cheats-updates',
		uk: 'onovlennya-chitiv-ark',
		cs: 'escape-from-ark-cheats-aktualizace',
		ro: 'actualizari-cheats-ark',
		sv: 'escape-from-ark-cheats-uppdateringar',
	},
	faq: {
		en: 'faq',
		es: 'preguntas-trucos-ark',
		fr: 'faq-triche-ark',
		de: 'escape-from-ark-cheats-faq',
		pt: 'faq-cheats-ark',
		it: 'faq-trucchi-ark',
		nl: 'escape-from-ark-cheats-faq',
		pl: 'faq-cheatow-ark',
		ru: 'faq-chitov-ark',
		tr: 'ark-hile-sss',
		ar: 'escape-from-ark-cheats-faq',
		ja: 'escape-from-ark-cheats-faq',
		ko: 'escape-from-ark-cheats-faq',
		zh: 'escape-from-ark-cheats-faq',
		hi: 'escape-from-ark-cheats-faq',
		id: 'escape-from-ark-cheats-faq',
		th: 'escape-from-ark-cheats-faq',
		vi: 'escape-from-ark-cheats-faq',
		uk: 'faq-chitiv-ark',
		cs: 'escape-from-ark-cheats-faq',
		ro: 'faq-cheats-ark',
		sv: 'escape-from-ark-cheats-faq',
	},
	support: {
		en: 'support',
		es: 'soporte-trucos-ark',
		fr: 'support-triche-ark',
		de: 'escape-from-ark-cheats-support',
		pt: 'suporte-cheats-ark',
		it: 'supporto-trucchi-ark',
		nl: 'escape-from-ark-cheats-support',
		pl: 'wsparcie-cheatow-ark',
		ru: 'podderzhka-chitov-ark',
		tr: 'ark-hile-destek',
		ar: 'escape-from-ark-cheats-support',
		ja: 'escape-from-ark-cheats-support',
		ko: 'escape-from-ark-cheats-support',
		zh: 'escape-from-ark-cheats-support',
		hi: 'escape-from-ark-cheats-support',
		id: 'escape-from-ark-cheats-support',
		th: 'escape-from-ark-cheats-support',
		vi: 'escape-from-ark-cheats-support',
		uk: 'pidtrymka-chitiv-ark',
		cs: 'escape-from-ark-cheats-podpora',
		ro: 'suport-cheats-ark',
		sv: 'escape-from-ark-cheats-support',
	},
	undetected: {
		en: 'undetected-ark-cheats',
		es: 'trucos-ark-indetectables',
		fr: 'triche-ark-indetectable',
		de: 'unentdeckte-escape-from-ark-cheats',
	...
	'best-cheats': {
		...
		de: 'beste-escape-from-ark-cheats',
		pt: 'melhores-cheats-ark',
		it: 'migliori-trucchi-ark',
		nl: 'beste-escape-from-ark-cheats',
		...
		cs: 'nejlepsi-escape-from-ark-cheats',
		ro: 'cele-mai-bune-cheats-ark',
		sv: 'basta-escape-from-ark-cheats',
	},
	'aimbot-hack': {
		en: 'ark-aimbot-hack',
...
export function resolvePageContextFromPath(pathname: string): PageContext {
	...
	if (rest[0] === 'forums') {
		if (rest.length === 1) {
			return { locale, isForumsIndex: true };
		}
...
export function getPageLocaleSwitchHref(context: PageContext, targetLocale: LocaleCode): string {
	if (context.isForumsIndex) {
		return getForumsBasePath(targetLocale);
	}
	if (context.forumSlug) {
		return getForumThreadPath(context.forumSlug, targetLocale);
	}
	if (context.pageId) {
