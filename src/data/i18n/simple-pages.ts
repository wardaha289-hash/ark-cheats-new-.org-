...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
		...
		sections: [
			{
				h2: 'Player & dino ESP',
				paragraphs: [
					'See players, wild dinos, and tamed creatures through walls with distance readouts.',
					'Use dino filters so the overlay stays clear on The Island, Scorched Earth, and Aberration.',
				],
				list: ['Player ESP boxes & distance', 'Dino ESP with dino filters', 'Item ESP for loot and resources'],
			},
			{
				h2: 'Aimbot & combat',
				paragraphs: [
					'Aimbot you can tune for PvP and PvE.',
					'Set FOV, smoothness, and target priority before you join a server.',
				],
				list: ['Aimbot with smoothness', 'FOV changer & zoom', 'Crosshair overlay'],
			},
			{
				h2: 'Weapon tools',
				paragraphs: [
					'Combat helpers for ranged and melee fights.',
					'Reduce recoil and spread for cleaner shots in tribe wars.',
				],
				list: ['No recoil', 'No spread', 'Rapid fire'],
			},
			{
				h2: 'Updates & support',
				paragraphs: [
	...
	updates: page({
		...
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Ark Cheats overview',
		...
		sections: [
			{
				h2: 'Current status',
				paragraphs: [
					'As of 13 Aug 2026 the package is online for ARK: Survival Ascended on Windows PC. We post a new note here when a game or Easy Anti-Cheat patch needs a rebuild.',
		...
		sections: [
			{
				h2: 'What you get',
				paragraphs: [
					'One license for ARK: Survival Ascended on Windows PC — built for PvP servers and PvE maps.',
				],
				list: [
					'Player ESP & dino ESP',
					'Aimbot & crosshair',
					'Item ESP with dino filters',
					'Easy Anti-Cheat rebuilds after patches',
				],
			},
			{
				h2: 'Built for ARK survival',
				paragraphs: [
					'Track players and wild dinos before you push, mark loot worth the risk, and stay aware near tribe bases. Tune aimbot and FOV for PvP fights and taming runs.',
				],
				list: [
	...
	'ark-esp': page({
		title: 'Ark ESP | {brand}',
		description:
			'Ark ESP and wallhack for ARK: Survival Ascended on Windows PC — player ESP, dino ESP, item ESP, distance, and dino filters.',
		h1: 'ESP',
		intro: 'See players, dinos, and loot through walls in ARK. Part of the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Ark Cheats overview',
		ctaSecondaryHref: '/ark-cheats/',
		...
		sections: [
			{
				h2: 'What ESP shows',
				paragraphs: ['Boxes, distance, and filters for players, wild dinos, alpha dinos, and loot.'],
				list: ['Player ESP', 'Loot markers', 'Boss and dino filters'],
			},
			{
				h2: 'When to use it',
				paragraphs: ['Clear dorms, Factory, and PvE maps without flooding the screen.'],
			...
			},
			{
				...
				list: [
					'<a href="/ark-cheats/">Full product</a>',
	...
	'ark-aimbot': page({
		...
		description:
			'Ark aimbot for ARK: Survival Ascended on Windows PC — FOV changer, zoom, smoothness, and crosshair you can tune per weapon.',
		h1: 'Aimbot',
		intro: 'Aimbot and combat tools you can tune for ARK. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Ark Cheats overview',
		ctaSecondaryHref: '/ark-cheats/',
		...
		sections: [
			{
				...
				list: ['Aimbot strength', 'FOV changer & zoom', 'Crosshair overlay'],
			},
			{
				h2: 'Play styles',
				paragraphs: ['Keep settings subtle for longer sessions. Raise strength only when you accept more risk.'],
				list: ['Legit aimbot', 'No recoil & no spread', 'Works with ESP'],
			},
			{
				h2: 'Next steps',
				paragraphs: ['Aimbot ships with player ESP, dino ESP, and item ESP in one license.'],
				list: [
					'<a href="/ark-cheats/">Full product</a>',
					'<a href="/features/">All features</a>',
					'<a href="/pricing/">Store</a>',
	...
	radar: page({
		...
		description:
			'Tarkov 2D radar for ARK: Survival Ascended on Windows PC — flank cues near tribe bases without filling the whole screen.',
		h1: 'Radar',
		...
		sections: [
			{
				h2: 'What it shows',
				paragraphs: ['Nearby enemy cues with adjustable range for PMC and PvE maps.'],
